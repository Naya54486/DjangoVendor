...
from .views.User import SetPassword, LoginUser, get_user_token
...
urlpatterns = [
    ...
    path('api/v.1/User/setpassword/<str:pk>', SetPassword.as_view(), name = 'setpassword'),
    path('api/v.1/User/login', LoginUser.as_view(), name = 'login'),
    path('apiv.1/User/token', get_user_token, name='get_auth_token'),
